...
$sql = "update `document_tbl` set `document_name` = '".$document_name."', `photo` = '".$filename1."', `status` = '".$status."'  where `id` = '".$id."'";
        ...
        <div class="container container__bscreen">
          <div class="row">
		   ...
		   <?php
                    ...
                    $sql = "SELECT * FROM   document_tbl	  WHERE id='".$id."'";
                      ...
                      <div class="col-lg-12 col-12 mg-top-30">
                        ...
                        <div class="crancy-product-card">
						  ...
						  <div class="crancy__item-form--group mg-top-25">
                            ...
                            >
                            <input
                              class="crancy__item-input"  value="<?php echo $row['document_name']; ?>"
                              type="text" name="document_name"
                              placeholder=""
                              required="required"
                            />
                          </div>
