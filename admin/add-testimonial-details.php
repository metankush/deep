...
if($_SERVER["REQUEST_METHOD"] == "POST"){
 ...
 $photo = $_FILES['photo']['name'];
  ...
  $sql = "INSERT INTO `testimonial_tbl` (`name`, `description`,  `photo`,   `status`) VALUES ('$name', '".$_POST['description']."', '$filename1', '".$_POST['status']."')";
						...
						<div class="col-lg-6">
						  ...
						  <div class="crancy__item-form--group mg-top-25">
                            <label
							  ...
							  Description</label
                            >
                                                        <textarea  id="aboutu1" name="description" class="form-control margin-bottom-20"></textarea>
