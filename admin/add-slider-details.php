...
if($_SERVER["REQUEST_METHOD"] == "POST"){
 ...
 $photo = $_FILES['photo']['name'];
  ...
  $sql = "INSERT INTO `sliders_tbl` (`title_name`, `description`, `photo`,  `status`, `multimedia_type`) VALUES ('$title_name', '".$_POST['description']."', '$filename1', '".$_POST['status']."', '".$_POST['multimedia_type']."')";
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                header("location: slider-details.php");
            } else{
                      ...
                      <div class="col-lg-12 col-12 mg-top-30">
                        ...
                        <div class="crancy-product-card">
						  ...
						  <div class="crancy__item-form--group mg-top-25">
                            ...
                            >
                              <option selected="">SELECT Multimedia Format Type</option>
