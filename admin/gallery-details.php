          ...
          <div class="crancy-table crancy-table--v3 mg-top-30">
            <div class="crancy-customer-filter">
              ...
              <div class="crancy-customer-filter__single"> <a
                          href="add-gallery-details.php"
                          class="crancy-customer-filter__single--button"
                        > Add Gallery Details  </a> </div>
            </div>
            <!-- crancy Table -->
...
<th>Action</th>
              ...
              <tbody class="crancy-table__body">
                    ...
                    $sql = "SELECT r.category_id, r.photo,  r.id, r.status, e.category_name
       FROM photo_category_tbl e
       JOIN gallery_tbl r ON e.id=r.category_id";
                    ...
                    while($row = $query->fetch_assoc()){
                      ?>
                          ...
                          <td><a href="update-gallery-details.php?action=update&id=<?php echo $row['id']; ?>"><img src="img/<?php echo $row['photo']; ?>" style="width:50%; height:100px;"/></a></td>
...
?></td>
                                        ...
                                        <td>
                                            <a class="me-3" href="update-gallery-details.php?action=update&id=<?php echo $row['id']; ?>">
                                                <img src="../assets/img/icons/edit.svg" alt="img">
                                            </a>
                                            <a class="me-3 confirm-text" href="delete-gallery-details.php?id=<?php echo $row['id']?>&del=delete">
