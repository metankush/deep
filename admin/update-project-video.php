...
$id = $_REQUEST['id'];
	 ...
	 $video = $_FILES['video']['name'];
	  $filename1 = time()."-".rand(1000, 9999)."-".$video;												 
 
		if(!empty($filename1)){
			move_uploaded_file($_FILES['video']['tmp_name'], 'img/'.$filename1);	
		}
...
$sql = "update `project_tbl` set `video` = '".$filename1."',  `status` = '".$status."'  where `id` = '".$id."'";
...
<head>
    ...
    <!-- Site Title -->
    <title>Update Project Video</title>
                      ...
                      <div class="col-lg-12 col-12 mg-top-30">
                        ...
                        <div class="crancy-product-card">
						  ...
						  <div class="crancy__item-form--group mg-top-25">
                            ...
                            >
                            <input
                              class="crancy__item-input"  value="<?php echo $row['video']; ?>"
