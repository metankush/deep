...
$sql = "update `video_category_tbl` set `category_name` = '".$category_name."',  `status` = '".$status."'  where `id` = '".$id."'";
...
<head>
    ...
    <!-- Site Title -->
    <title>Update Video Category </title>
        ...
        <div class="container container__bscreen">
          <div class="row">
		   ...
		   <?php
                    ...
                    $sql = "SELECT * FROM   video_category_tbl	  WHERE id='".$id."'";
