...
<div class="container container__bscreen">
 ...
 Details</h3>
              ...
              <div class="crancy-customer-filter__single"> <a
                          href="add-project-area.php"
                          class="crancy-customer-filter__single--button"
                        > Add Projects Area </a> </div>
            </div>
            <!-- crancy Table -->
...
?></td>
                                        ...
                                        <td>
                                            <a class="me-3" href="update-project-area-details.php?action=update&id=<?php echo $row['id']; ?>">
                                                <img src="../assets/img/icons/edit.svg" alt="img">
                                            </a>
                                            <a class="me-3 confirm-text" href="delete-project-area-details.php?id=<?php echo $row['id']?>&del=delete">
