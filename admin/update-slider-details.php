...
$id = $_REQUEST['id'];
	 ...
	 $title_name = $_POST['title_name'];
										         $description = $_POST['description'];
												   ...
												   $multimedia_type = $_POST['multimedia_type'];
...
$sql = "update `sliders_tbl` set `title_name` = '".$title_name."', `multimedia_type` = '".$multimedia_type."', `description` = '".$description."', `status` = '".$status."'  where `id` = '".$id."'";

if ($link->query($sql) === TRUE) {
	header("Location: sliders-details.php");
} else {
      ...
      <section class="crancy-adashboard crancy-show">
        <div class="container container__bscreen">
		  ...
		  <?php
                    ...
                    $sql = "SELECT * FROM   sliders_tbl	  WHERE id='".$id."'";
                        ...
                        <div class="crancy-product-card">
						  ...
						  <div class="crancy__item-form--group mg-top-25">
                            ...
                            <input
                              ...
                              type="text" name="title_name" value="<?php echo $row['title_name']; ?>"
                              placeholder=""
                              required="required"
                            />
                          </div>
						  ...
						  <div class="crancy__item-form--group mg-top-25">
                            ...
                            >
                            <input
                              class="crancy__item-input" value="<?php echo $row['description']; ?>"
						  ...
						  <div class="crancy__item-form--group mg-top-25">
                            <label
                              class="crancy__item-label crancy__item-label-product"
                              >Multimedia Format Type</label
                            >
                            <select
                              class="form-select crancy__item-input" name="multimedia_type"
                              aria-label="Default select example"
                            >
                              <option value="<?php echo $row['multimedia_type']; ?>">SELECT Multimedia Format Type</option>
