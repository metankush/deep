...
if($_SERVER["REQUEST_METHOD"] == "POST"){
 ...
 $photo = $_FILES['photo']['name'];
  ...
  $sql = "INSERT INTO `photo_category_tbl` (`category_name`,  `photo`,  `status`) VALUES ('$category_name',  '$filename1', '".$_POST['status']."')";
...
<head>
    ...
    <!-- Site Title -->
    <title>Add Photo Category</title>
