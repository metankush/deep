...
<meta
    ...
    />
<!-- Site Title -->
<title>Projects Area-Details</title>
<!-- Fav Icon -->
...
<div class="container container__bscreen">
 ...
 Details</h3>
              ...
              <div class="crancy-customer-filter__single"> <a
                          href="add-testimonial-details.php"
                      ...
                      ?>
                                    <tr>
                                        ...
                                        <td><?php echo $row['name']; ?></td>
										  ...
										  <td><a href="update-testimonial-image.php?action=update&id=<?php echo $row['id']; ?>"><img src="img/<?php echo $row['photo']; ?>" style="width:50px;"/></a></td>
...
?></td>
                                        ...
                                        <td>
                                            <a class="me-3" href="update-testimonial.php?action=update&id=<?php echo $row['id']; ?>">
                                                <img src="../assets/img/icons/edit.svg" alt="img">
                                            </a>
                                            <a class="me-3 confirm-text" href="delete-testimonial.php?id=<?php echo $row['id']?>&del=delete">
