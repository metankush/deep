...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["email"]))){
     ...
     //   mysqli_stmt_close($stmt);
	  ...
	  $videofile = time()."-".rand(1000, 9999)."-".$video;												 
 
		if(!empty($videofile)){
			move_uploaded_file($_FILES['video']['tmp_name'], 'img/'.$videofile);	
		}    				  
  ...
  $sql = "INSERT INTO `project_tbl` (`area_id`, `category_id`,  `subcategory_id`,  `project_name`, `product_description`,  `price`,  `address`,  `google_map`, `description`,  `photo`,  `status`, `video`) VALUES ('$area_id', '$category_id',  '$subcategory_id', '".$_POST['project_name']."', '$product_description',  '$price',  '$address', '".$_POST['google_map']."', '$description',  '$filename1', '".$_POST['status']."',  '$videofile')";
...
<option value="">Select Sub Category</option>
						  ...
						  <div class="crancy__item-form--group mg-top-25">
                            ...
                            >
                              <textarea  id="aboutu1" name="product_description" class="form-control margin-bottom-20"></textarea>
