...
if($_SERVER["REQUEST_METHOD"] == "POST"){
 ...
 $photo = $_FILES['photo']['name'];
  ...
  $sql = "INSERT INTO `property_features_tbl` (`category_id`, `subcategory_id`, `photo`,  `project_id`, `features_name`) VALUES ('$category_id', '".$_POST['subcategory_id']."', '$filename1', '".$_POST['project_id']."', '".$_POST['features_name']."')";
...
<head>
    ...
    <!-- Site Title -->
    <title>Add Property Features</title>
