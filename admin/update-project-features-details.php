...
$sql = "update `property_features_tbl` set `features_name` = '".$features_name."'  where `id` = '".$id."'";
...
<head>
    ...
    <!-- Site Title -->
    <title>Update Property Features </title>
        ...
        <div class="container container__bscreen">
          <div class="row">
		   ...
		   <?php
                    ...
                    $sql = "SELECT * FROM   property_features_tbl	  WHERE id='".$id."'";
                      ...
                      <div class="col-lg-12 col-12 mg-top-30">
                        ...
                        <div class="crancy-product-card">
						  ...
						  <div class="crancy__item-form--group mg-top-25">
                            ...
                            >
                            <input
                              class="crancy__item-input"  value="<?php echo $row['features_name']; ?>"
                              type="text" name="features_name"
                              placeholder=""
                              required="required"
                            />
                          </div>
