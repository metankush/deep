...
<meta
    ...
    />
<!-- Site Title -->
<title>Video Category-Details</title>
<!-- Fav Icon -->
...
<div class="container container__bscreen">
 ...
 Details</h3>
              ...
              <div class="crancy-customer-filter__single"> <a
                          href="add-video-category-details.php"
                          class="crancy-customer-filter__single--button"
                        > Add Video Category  </a> </div>
            </div>
            <!-- crancy Table -->
              ...
              <tbody class="crancy-table__body">
                    ...
                    while($row = $query->fetch_assoc()){
                      ?>
                          ...
                          <td><a href="update-video-category-image.php?action=update&id=<?php echo $row['id']; ?>"><img src="img/<?php echo $row['photo']; ?>" style="width:50%; height:100px;"/></a></td>
...
?></td>
                                        ...
                                        <td>
                                            <a class="me-3" href="update-video-category-details.php?action=update&id=<?php echo $row['id']; ?>">
                                                <img src="../assets/img/icons/edit.svg" alt="img">
                                            </a>
                                            <a class="me-3 confirm-text" href="delete-video-category-details.php?id=<?php echo $row['id']?>&del=delete">
