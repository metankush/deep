...
$sql = "update `project_tbl` set `area_id` = '".$area_id."', `category_id` = '".$category_id."',  `subcategory_id` = '".$subcategory_id."', `project_name` = '".$project_name."',  `product_description` = '".$product_description."',  `price` = '".$price."',  `address` = '".$address."', `google_map` = '".$google_map."',  `description` = '".$description."', `status` = '".$status."'  where `id` = '".$id."'";
...
$query ="SELECT * FROM project_category_tbl";
...
<head>
    ...
    <!-- Site Title -->
    <title>Update Projects Details</title>
...
function getpanchayat(val) {
	$.ajax({
	type: "POST",
	url: "getpanchayat.php",
	data:'block_id='+val,
	success: function(data){
		$("#panchayat-list").html(data);
		getvillage();
	}
	});
}
        ...
        <div class="container container__bscreen">
          <div class="row">
		     <?php
                    ...
                    $sql = "SELECT r.category_id, r.subcategory_id, r.project_name, r.product_description,  r.price, r.area_id, r.address, r.google_map, r.photo, r.description,  r.id, r.status, e.project_cate_name, m.subcategory_name
...
<option value="<?php echo $row['area_id']; ?>">Select Area Name </option>
<?php
                    ...
                    while($rows = $query->fetch_assoc()){
                      ?>
<option value="<?php echo $rows["id"]; ?>"><?php echo $rows["area_name"]; ?></option>
<?php
}
?>
</select>
						  ...
						  <div class="crancy__item-form--group mg-top-25">
                            ...
                            >
							    <select class="form-control" name="category_id" id="country-list" onChange="getState(this.value);" required>
<option  value="<?php echo $row['category_id']; ?>">Select Category Name </option>
<?php
foreach($results as $country) {
?>
<option value="<?php echo $country["id"]; ?>"><?php echo $country["project_cate_name"]; ?></option>
<?php
}
?>
</select>
						  ...
						  <div class="crancy__item-form--group mg-top-25">
                            <label
                              ...
                              >Sub Category</label
                            >
                          <select class="form-control" name="subcategory_id" id="state-list" onChange="getCity(this.value);">
<option  value="<?php echo $row['subcategory_id']; ?>">Select Sub Category</option>
						  ...
						  <div class="crancy__item-form--group mg-top-25">
                            ...
                            <input
                              ...
                              type="text" name="project_name"  value="<?php echo $row['project_name']; ?>"
                              placeholder=""
                              required="required"
                            />
                          </div>
						  ...
						  <div class="crancy__item-form--group mg-top-25">
                            ...
                            >
                            <input
                              class="crancy__item-input"  value="<?php echo $row['price']; ?>"
						  ...
						  <div class="crancy__item-form--group mg-top-25">
                            ...
                            <input
                              class="crancy__item-input"
                              type="text" name="address"  value="<?php echo $row['address']; ?>"
                              placeholder=""
                              required="required"
                            />
                          </div>
						  ...
						  <div class="crancy__item-form--group mg-top-25">
                            ...
                            <input
                              class="crancy__item-input"
                              type="text" name="google_map"  value="<?php echo $row['google_map']; ?>"
                              placeholder=""
                              required="required"
                            />
                          </div>
						  ...
						  <div class="crancy__item-form--group mg-top-25">
                            ...
                            >
                              <textarea  id="aboutu1" name="product_description" class="form-control margin-bottom-20"><?php echo $row['product_description']; ?></textarea>
						  ...
						  <div class="crancy__item-form--group mg-top-25">
                            ...
                            >
                            <select
                              class="form-select crancy__item-input" name="status"
...
<script>
    CKEDITOR.replace( 'aboutu1' );
    CKEDITOR.replace( 'aboutu2' );
    CKEDITOR.replace( 'aboutu3' );
    CKEDITOR.replace( 'aboutu4' );
	 CKEDITOR.replace( 'aboutu5' );
	 	 CKEDITOR.replace( 'aboutu6' );
