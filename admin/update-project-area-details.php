...
$sql = "update `project_area_tbl` set `area_name` = '".$area_name."',  `status` = '".$status."'  where `id` = '".$id."'";

if ($link->query($sql) === TRUE) {
	header("Location:project-area-details.php");
} else {
...
<head>
    ...
    <!-- Site Title -->
    <title>Update Projects Area </title>
        ...
        <div class="container container__bscreen">
          <div class="row">
		   ...
		   <?php
                    ...
                    $sql = "SELECT * FROM   project_area_tbl	  WHERE id='".$id."'";
                      ...
                      <div class="col-lg-12 col-12 mg-top-30">
                        ...
                        <div class="crancy-product-card">
						  ...
						  <div class="crancy__item-form--group mg-top-25">
                            ...
                            >
                            <input
                              class="crancy__item-input"  value="<?php echo $row['area_name']; ?>"
