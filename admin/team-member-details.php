...
<div class="container container__bscreen">
 ...
 Details</h3>
              ...
              <div class="crancy-customer-filter__single"> <a
                          href="add-team-member.php"
                          class="crancy-customer-filter__single--button"
                        > Add Team Member  </a> </div>
            </div>
            <!-- crancy Table -->
              ...
              <tbody class="crancy-table__body">
                    ...
                    while($row = $query->fetch_assoc()){
                      ?>
                          ...
                          <td><a href="update-team-member-image.php?action=update&id=<?php echo $row['id']; ?>"><img src="img/<?php echo $row['photo']; ?>" style="width:50%; height:100px;"/></a></td>
...
?></td>
                                        ...
                                        <td>
                                            <a class="me-3" href="update-team-member.php?action=update&id=<?php echo $row['id']; ?>">
                                                <img src="../assets/img/icons/edit.svg" alt="img">
                                            </a>
                                            <a class="me-3 confirm-text" href="delete-team-member.php?id=<?php echo $row['id']?>&del=delete">
