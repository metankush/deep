...
$sql = "update `youtube_tbl` set `category_id` = '".$category_id."', `youtube_link` = '".$youtube_link."',  `status` = '".$status."'  where `id` = '".$id."'";
...
<head>
    ...
    <!-- Site Title -->
    <title>Update  Youtube Video  Details</title>
  ...
  <body id="crancy-dark-light">
    <div class="crancy-body-area">
      ...
      <section class="crancy-adashboard crancy-show">
       ...
       JOIN youtube_tbl r ON e.id=r.category_id	  WHERE r.id='".$id."'";
                      ...
                      <div class="col-lg-12 col-12 mg-top-30">
                        ...
                        <div class="crancy-product-card">
						  ...
						  <div class="crancy__item-form--group mg-top-25">
                            ...
                            >
                            <select
                              class="form-select crancy__item-input" name="category_id"
                              aria-label="Default select example"
                            >
                              <option value="<?php echo $row['id']; ?>">Select  Category</option>
                    ...
                    while($rows = $query->fetch_assoc()){
                      ?>
						  ...
						  <div class="crancy__item-form--group mg-top-25">
                            <label
                              class="crancy__item-label crancy__item-label-product"
                              >	Youtube Vedio Link</label
                            >
                            <input
                              class="crancy__item-input"  value="<?php echo $row['youtube_link']; ?>"
