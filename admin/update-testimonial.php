...
$sql = "update `testimonial_tbl` set `name` = '".$name."', `description` = '".$description."',  `status` = '".$status."'  where `id` = '".$id."'";
                      ...
                      <div class="col-lg-12 col-12 mg-top-30">
                        ...
                        <div class="crancy-product-card">
						  ...
						  <div class="crancy__item-form--group mg-top-25">
                            ...
                            >
                            <input
                              class="crancy__item-input" value="<?php echo $row['name']; ?>"
                              type="text" name="name"
                              placeholder=""
                              required="required"
                            />
						  ...
						  <div class="crancy__item-form--group mg-top-25">
                            <label
							  ...
							  Description</label
                            >
                                                        <textarea  id="aboutu1" name="description" class="form-control margin-bottom-20"><?php echo $row['description']; ?></textarea>
