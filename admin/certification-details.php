...
<div class="container container__bscreen">
 ...
 Details</h3>
              ...
              <div class="crancy-customer-filter__single"> <a
                          href="add-certificate.php"
                          class="crancy-customer-filter__single--button"
                        > Add Certificate  </a> </div>
            </div>
            <!-- crancy Table -->
                      ...
                      ?>
                                    <tr>
                                        ...
                                        <td><?php echo $row['document_name']; ?></td>
										 ...
										 <td><a target="_blank" href="img/<?php echo $row['photo']; ?>"> <span class="img-click-here"><img src="icon/click-here.gif" alt="" style="width:50px;"></span> </a></td>
...
?></td>
                                        ...
                                        <td>
                                            <a class="me-3" href="update-certification.php?action=update&id=<?php echo $row['id']; ?>">
                                                <img src="../assets/img/icons/edit.svg" alt="img">
                                            </a>
                                            <a class="me-3 confirm-text" href="delete-certification-list.php?id=<?php echo $row['id']?>&del=delete">
