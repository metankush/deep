...
if($_SERVER["REQUEST_METHOD"] == "POST"){
 ...
 $photo = $_FILES['photo']['name'];
  ...
  $sql = "INSERT INTO `project_certificate_tbl` (`category_id`, `subcategory_id`, `photo`,  `project_id`, `certificate_name`) VALUES ('$category_id', '".$_POST['subcategory_id']."', '$filename1', '".$_POST['project_id']."', '".$_POST['certificate_name']."')";
