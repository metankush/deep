...
$sql = "update `photo_category_tbl` set `category_name` = '".$category_name."',  `status` = '".$status."'  where `id` = '".$id."'";

if ($link->query($sql) === TRUE) {
	header("Location: photo-category-details.php");
} else {
...
<head>
    ...
    <!-- Site Title -->
    <title>Update Photo Category </title>
        ...
        <div class="container container__bscreen">
          <div class="row">
		   ...
		   <?php
                    ...
                    $sql = "SELECT * FROM   photo_category_tbl	  WHERE id='".$id."'";
                      ...
                      <div class="col-lg-12 col-12 mg-top-30">
                        ...
                        <div class="crancy-product-card">
						  ...
						  <div class="crancy__item-form--group mg-top-25">
                            ...
                            >
                            <input
                              class="crancy__item-input"  value="<?php echo $row['category_name']; ?>"
