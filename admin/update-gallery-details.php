...
$sql = "update `gallery_tbl` set `category_id` = '".$category_id."', `photo` = '".$filename1."',  `status` = '".$status."'  where `id` = '".$id."'";
...
<head>
    ...
    <!-- Site Title -->
    <title>Update Gallery Details</title>
  ...
  <body id="crancy-dark-light">
    <div class="crancy-body-area">
      ...
      <section class="crancy-adashboard crancy-show">
       ...
       JOIN gallery_tbl r ON e.id=r.category_id	  WHERE r.id='".$id."'";
