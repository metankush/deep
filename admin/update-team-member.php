...
$sql = "update `team_tbl` set `name` = '".$name."', `mob_no` = '".$mob_no."', `status` = '".$status."'  where `id` = '".$id."'";

if ($link->query($sql) === TRUE) {
	header("Location: team-member-details.php");
} else {
                      ...
                      <div class="col-lg-12 col-12 mg-top-30">
                        ...
                        <div class="crancy-product-card">
						  ...
						  <div class="crancy__item-form--group mg-top-25">
                            <label
                              class="crancy__item-label crancy__item-label-product"
                              >	Team Member Mob No</label
                            >
                            <input
                              class="crancy__item-input"  value="<?php echo $row['mob_no']; ?>"
                              type="text" name="mob_no"
                              placeholder=""
                              required="required"
                            />
                          </div>
