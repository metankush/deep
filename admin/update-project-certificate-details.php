...
$sql = "update `project_certificate_tbl` set `certificate_name` = '".$certificate_name."', `photo` = '".$filename1."'  where `id` = '".$id."'";
...
<head>
    ...
    <!-- Site Title -->
    <title>Update Project Certificate  </title>
        ...
        <div class="container container__bscreen">
          <div class="row">
		   ...
		   <?php
                    ...
                    $sql = "SELECT * FROM   project_certificate_tbl	  WHERE id='".$id."'";
                      ...
                      <div class="col-lg-12 col-12 mg-top-30">
                        ...
                        <div class="crancy-product-card">
						  ...
						  <div class="crancy__item-form--group mg-top-25">
                            ...
                            >
                            <input
                              class="crancy__item-input"  value="<?php echo $row['certificate_name']; ?>"
