...
<head>
    ...
    <title>Deep Sheetal || About</title>
...
<body>
                ...
                <div class="offcanvas-content">
                    ...
                    <div class="offcanvas-contact mb-25">
                        ...
                        <ul>
                            ...
                            <li class="d-flex align-items-center gap-10">
                                <div class="offcanvas-contact-icon">
                                    <a href="tel:+91 0000000000"><i class="far fa-phone"></i></a>
                                </div>
                                <div class="offcanvas-contact-text">
    ...
    <main>
        ...
        <section class="bd-breadcrumb-area p-relative fix">
            ...
            <div class="bd-breadcrumb-bg" data-background="assets/images/breadcrumb/about-banner.jpg"></div>
      ...
      <!-- About area start -->
      <section class="bd-about-area section-space">
        <div class="container">
            <div class="row g-5 align-items-lg-center">
                <div class="col-xxl-5 col-xl-5 col-lg-6 col-md-6 wow bdFadeInLeft" data-wow-delay=".3s" data-wow-duration="1s">
                    <div class="section-title-wrapper anim-wrapper animation-style-3 mb-30">
                        <span class="section-subtitle uppercase">
    <i class="icon-home"></i>
    about us
</span>
                        <h2 class="section-title title-animation">We Provide Right Choice of Properties</h2>
                    </div>
                ...
                <div class="col-xxl-7 col-xl-7 col-lg-6 col-md-6">
                    <div class="about-thumb-wrapper style-two wow bdFadeInRight" data-wow-delay=".4s" data-wow-duration="1s">
                        <div class="about-thumb-one">
                            <img src="assets/images/about/about-thumb-04.png" alt="about thumb">
                        </div>
                        <div class="about-thumb-two">
                            <img src="assets/images/about/about-thumb-05.png" alt="about thumb">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- About area end -->
        ...
        <!-- counter area end -->
           ...
           <!-- Team area start -->
           <!-- <section class="bd-team-area fix section-space">
    <div class="container">
        <div class="row g-5">
                ...
                <div class="team-content-inner d-flex flex-column justify-content-between h-100">
                    <div class="team-intro-content style-one">
                      ...
                      Team members
                            ...
                            <h2 class="section-title title-animation">Meet our Management Team</h2>
                        </div>
                        <a class="bd-half-outline-btn" href="management.php"><span class="text">Discover More</span></a>
                    </div>
            ...
            <div class="col-xxl-8 col-xl-8">
                <div class="team-slider-inner wow bdFadeInUp" data-wow-delay=".3s">
                    <div class="swiper team-slider-active">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="team-item style-one">
                                    <div class="thumb">
                                        <figure><img src="assets/images/team.jpg" alt="team thumb not found">
                                        </figure>
                                    </div>
                                    <div class="content-inner">
                                        <div class="content">
                                            <h3 class="title"><a href="management.php">Rahul Kumar</a></h3>
                                            <span class="info"><a href="tel:+91 0000000000">+91 0000000000</a></span>
                                        </div>
                            ...
                            <div class="swiper-slide">
                                <div class="team-item style-one">
                                    ...
                                    <div class="content-inner">
                                        <div class="content">
                                            <h3 class="title"><a href="management.php">Reajes Kumar</a></h3>
                                            <span class="info"><a href="tel:+91 0000000000">+91 0000000000</a></span>
                                        </div>
                                        <div class="team-social">
                                            <ul>
                            ...
                            <div class="swiper-slide">
                                <div class="team-item style-one">
                                    ...
                                    <div class="content-inner">
                                        <div class="content">
                                            <h3 class="title"><a href="management.php">Rohit Kumar</a></h3>
                                            <span class="info"><a href="tel:+91 0000000000">+91 0000000000</a></span>
                                        </div>
                                        <div class="team-social">
                                            <ul>
                            ...
                            <div class="swiper-slide">
                                <div class="team-item style-one">
                                    ...
                                    <div class="content-inner">
                                        <div class="content">
                                            <h3 class="title"><a href="management.php">Sonu Kumar</a></h3>
                                            <span class="info"><a href="tel:+91 0000000000">+91 0000000000</a></span>
                                        </div>
                                        <div class="team-social">
                                            <ul>
