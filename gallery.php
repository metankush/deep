...
<body>
    ...
    <main>
        ...
        <section class="bd-breadcrumb-area p-relative fix">
            ...
            <div class="bd-breadcrumb-bg" data-background="assets/images/breadcrumb/gallery-to-banner.jpg"></div>
        ...
        <section class="bd-contact-form section-space">
            <div class="container">
             <div class="row">
                    ...
                    $sql = "SELECT * FROM `gallery_tbl` WHERE `category_id` ='".$id."'";
                ...
                <div class="col-lg-4">
                    <figure class="image-box"><a href="admin/img/<?php echo $row['photo'];  ?>" class="lightbox-image" data-fancybox="gallery"><img src="admin/img/<?php echo $row['photo'];  ?>" alt></a></figure>
                </div>
