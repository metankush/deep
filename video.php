...
<head>
    ...
    <title>Deep Sheetal || Gallery</title>
...
<body>
    ...
    <main>
        ...
        <section class="bd-breadcrumb-area p-relative fix">
            ...
            <div class="bd-breadcrumb-bg" data-background="assets/images/breadcrumb/video-banner.jpg"></div>
                        ...
                        <div class="col-xl-10">
                            <div class="bd-breadcrumb">
                                <div class="bd-breadcrumb-content text-center">
                                    <h1 class="bd-breadcrumb-title">Video</h1>
        ...
        <section class="bd-contact-form section-space">
            <div class="container">
             <div class="row">
                    ...
                    $sql = "SELECT * FROM `youtube_tbl` WHERE `category_id` ='".$id."'";
                ...
                <div class="col-lg-4">
                    ...
                    <iframe width="100%" height="250" src="<?php echo $row['youtube_link'];  ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                </div>
                </div>
