...
<head>
    ...
    <title>Deep Sheetal || Certificate</title>
...
<body>
    ...
    <main>
        ...
        <section class="bd-breadcrumb-area p-relative fix">
            ...
            <div class="bd-breadcrumb-bg" data-background="assets/images/breadcrumb/certificate-banner.jpg"></div>
                        ...
                        <div class="col-xl-10">
                            <div class="bd-breadcrumb">
                                <div class="bd-breadcrumb-content text-center">
                                    <h1 class="bd-breadcrumb-title">Certificate</h1>
